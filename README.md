# Available One-Word Domains (11,045,947)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-11%2C045%2C947%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **11,045,947 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 11,045,947 domains · **Median ask:** $168.97 · **High-demand under $2,500:** 13,248
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 11,045,947 live domains                    |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 13,248 high-demand names under $2,500      |
...
This list covers available one-word domain names across more than 500 TLDs, from mainstream extensions to niche options like .expert, .ninja, and .zone. Pricing skews affordable: the majority ask under $500, with median pricing near $232. A smaller subset carries premium or resell status, reflecting stronger demand signals.

- 7.1M+ available one-word domains across 506 TLDs
- Median ask price: $231.82
- Most domains priced under $500; premium tier above $5k
- Demand mix spans low to top 15% high-demand names
...
> Unique Domains. *Available One-Word Domains*. Version 2026-09-06. Public GitHub extract for the exact Unique Domains search represented by this repository.
